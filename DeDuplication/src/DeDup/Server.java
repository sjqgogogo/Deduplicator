                ...
                do {
                    ...
                    if(input.equals("create")) {
                        ...
                        if(locker.sameFileNameExists(filename)) {
                            ...
                            file = new File(path+File.separator+"retrieved_"+filename);
                        ...
                        if(locker.sameFileNameExists(filename)) {
                            ...
                            out.println("delete "+filename+" successfully from the locker "+locker.getLockerName());
                            RunDedup.exportLocker(locker,lockerPath+File.separator+username);
                        ...
                        for(File f:fs){
                            {
                                ...
                                try {
                                    ...
                                    long tempsize = l.getcurrLockerSize();
                                    //System.out.println(tempsize);
                                    if(tempsize<=0) {
                                        out.println("there is nothing in this locker");
                                        out.println("empty locker will be deleted weekly");
                                        out.println("-------------------------------------------------------------------");
                                        continue;
                                    }
                                    out.println("size: "+tempsize);
                                    out.println("dedup ratio: "+l.getDedupRatio());
                                    int ii=1;
