...
public class MyLocker implements Serializable {
    ...
    protected boolean deleteFile(String fileName){
        ...
        deductSizeFromOriginal(f.getSize());
        deductFromLockerSize(f.getActualStoredSize());
        this.files.remove(f);
    ...
    protected void deductSizeFromOriginal(long size) { this.OriginalTotalfilesSize -= size; }
